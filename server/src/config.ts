...
export class Config {
    debugLogging = 'debug';
    'server.port' = '8081';
    'jhipster.clientApp.name' = 'specialistScheduler';
    ...
    'jhipster.mail.from' = 'specialistScheduler@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'specialistScheduler API';
    'jhipster.swagger.description' = 'specialistScheduler API documentation';
    ...
    'eureka.instance.appname' = 'specialistScheduler';
    'eureka.instance.instanceId' = 'specialistScheduler:${random.value}';
    ...
    'cloud.config.name' = 'specialistScheduler';
